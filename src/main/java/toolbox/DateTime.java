...
/**
 * Created by Letricia on 8/16/16.
 */
public class DateTime {
    ...
    public static void main(String[] args) {
        ...
        getSpecificDate(1990,12,19);
        isSameDates(1980,12,10);
        isAnniversary(2004,12,12);
        getCurrentTime();
        addHours(24);
        addWeeks(52);
        subtractYears(2016);
        ...
        isDateBefore(getCurrentDate(),getSpecificDate(2016,8,03));
        isDateAfter(getCurrentDate(),getSpecificDate(2012,5,05));
        isDateBetween(getSpecificDate(2009,5,6),getCurrentDate(),getSpecificDate(2004,5,06));
        daysBetweenDates(getSpecificDate(2004,5,02),getCurrentDate());
        printAllTimeZones();
        getCurrentZonedDateTime("MDT");
        howManyDaysInAMonth(2007,8);
        isLeapYear(2016);
        defaultFormatting("20091015");
        customFormatting("Dec042009");
